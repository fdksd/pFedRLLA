...
class MLPActor(nn.Module):
    ...
    def __init__(self, obs_dim, act_dim, hidden_sizes, activation, act_limit):
        ...
        self.lstm = nn.LSTM(32, hidden_sizes, num_layers=2, batch_first=True)
        self.fc = nn.Linear(hidden_sizes, act_dim)
...
class MLPQFunction(nn.Module):
    ...
    def __init__(self, obs_dim, act_dim, hidden_sizes, activation):
        super().__init__()
        self.lstm = nn.LSTM(32, hidden_sizes, num_layers=2, batch_first=True)
        self.fc = nn.Linear(hidden_sizes, 32)

        self.obs_dim = obs_dim
        self.q = mlp([obs_dim + act_dim] + list((28, 28)) + [1], activation)
...
class MLPActorCritic(nn.Module):
    ...
    def __init__(self, obs_dim, act_dim, hidden_sizes=256,
