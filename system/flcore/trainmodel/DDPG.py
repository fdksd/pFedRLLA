...
import torch
import flcore.trainmodel.core as core

# https://blog.csdn.net/weixin_43145941/article/details/112111312
...
class DDPG:
    def __init__(self, obs_dim, act_dim, act_bound, actor_critic=core.MLPActorCritic, seed=0, 
        ...
        # pre gamma 0.99 polyak 0.995
        # gamma 0.9 polyak 0.95 更好一些
        # size 100 gamma 0.9 polyak 0.95 lr 0.005 不好
    ...
    def compute_loss_q(self, data):   #返回(q网络loss, q网络输出的状态动作值即Q值)
        ...
        o2 = o2.view([len(o2), int(self.obs_dim/32), 32])
        q = self.ac.q(o, a)
